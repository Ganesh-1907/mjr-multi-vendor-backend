...
const seedData = async () => {
  try {
    ...
    const products = await Product.insertMany([
      { vendor: vendors[0]._id, category: electronics._id, name: 'iPhone 15 Pro Max', slug: 'iphone-15-pro-max', shortDescription: 'Apple iPhone 15 Pro Max 256GB', description: 'The most powerful iPhone ever. A17 Pro chip, 48MP camera system, and all-day battery life.', rating: 4.5, totalReviews: 128, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: true, tags: ['apple', 'iphone', 'smartphone'], specifications: { 'Display': '6.7-inch OLED', 'Processor': 'A17 Pro', 'Camera': '48MP Triple', 'Battery': '4422mAh' } },
      { vendor: vendors[0]._id, category: electronics._id, name: 'Samsung Galaxy S24 Ultra', slug: 'samsung-galaxy-s24-ultra', shortDescription: 'Samsung Galaxy S24 Ultra 512GB', description: 'Galaxy AI is here. Built with titanium, Galaxy S24 Ultra features a flat display with Corning Gorilla Armor.', rating: 4.3, totalReviews: 95, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: true, tags: ['samsung', 'galaxy', 'smartphone'], specifications: { 'Display': '6.8-inch Dynamic AMOLED', 'Processor': 'Snapdragon 8 Gen 3', 'Camera': '200MP Quad', 'Battery': '5000mAh' } },
      { vendor: vendors[0]._id, category: electronics._id, name: 'MacBook Pro 16"', slug: 'macbook-pro-16', shortDescription: 'Apple MacBook Pro 16" M3 Pro Chip', description: 'Supercharged by M3 Pro or M3 Max chip, MacBook Pro delivers extraordinary performance.', rating: 4.7, totalReviews: 67, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: false, tags: ['apple', 'macbook', 'laptop'], specifications: { 'Display': '16.2-inch Liquid Retina XDR', 'Processor': 'M3 Pro', 'Memory': '18GB Unified', 'Storage': '512GB SSD' } },
      { vendor: vendors[0]._id, category: electronics._id, name: 'Sony WH-1000XM5', slug: 'sony-wh-1000xm5', shortDescription: 'Sony WH-1000XM5 Wireless Noise Cancelling', description: 'Industry-leading noise cancellation with Auto NC Optimizer. Crystal clear hands-free calling.', rating: 4.6, totalReviews: 234, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: false, isTrending: true, tags: ['sony', 'headphones', 'noise-cancelling'], specifications: { 'Type': 'Over-ear Wireless', 'Battery': '30 hours', 'Noise Cancellation': 'Adaptive', 'Driver': '30mm' } },
      { vendor: vendors[1]._id, category: fashion._id, name: 'Cotton T-Shirt Set', slug: 'cotton-tshirt-set', shortDescription: 'Premium Cotton T-Shirt Set - Pack of 3', description: 'Ultra-comfortable 100% organic cotton t-shirts. Pre-shrunk, breathable fabric perfect for daily wear.', rating: 4.1, totalReviews: 456, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: false, tags: ['cotton', 't-shirt', 'casual'], specifications: { 'Material': '100% Organic Cotton', 'Fit': 'Regular', 'Pack': '3 Pieces', 'Care': 'Machine Washable' } },
      { vendor: vendors[1]._id, category: fashion._id, name: 'Designer Kurti', slug: 'designer-kurti', shortDescription: 'Designer Printed Rayon Kurti', description: 'Beautiful printed rayon kurti with elegant design. Perfect for casual and festive wear.', rating: 4.4, totalReviews: 189, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: true, tags: ['kurti', 'designer', 'ethnic'], specifications: { 'Material': 'Rayon', 'Length': 'Calf Length', 'Pattern': 'Printed', 'Neck': 'Round Neck' } },
      { vendor: vendors[2]._id, category: homeKitchen._id, name: 'Premium Cookware Set', slug: 'premium-cookware-set', shortDescription: '11-Piece Non-Stick Cookware Set', description: 'Complete kitchen cookware set with aluminum non-stick coating. Includes pots, pans, and lids.', rating: 4.3, totalReviews: 312, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: false, tags: ['cookware', 'kitchen', 'non-stick'], specifications: { 'Pieces': '11', 'Material': 'Aluminum Non-Stick', 'Oven Safe': 'Up to 180°C', 'Dishwasher': 'Safe' } },
      { vendor: vendors[2]._id, category: homeKitchen._id, name: 'Ergonomic Office Chair', slug: 'ergonomic-office-chair', shortDescription: 'High-Back Mesh Ergonomic Office Chair', description: 'Adjustable lumbar support, breathable mesh back, and comfortable cushion seat.', rating: 4.0, totalReviews: 78, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: false, isTrending: false, tags: ['office', 'chair', 'ergonomic'], specifications: { 'Material': 'Mesh + PU Leather', 'Adjustment': 'Height & Recline', 'Weight Capacity': '150kg', 'Warranty': '3 Years' } },
      { vendor: vendors[3]._id, category: sportsFitness._id, name: 'Premium Yoga Mat', slug: 'premium-yoga-mat', shortDescription: 'Extra Thick Non-Slip Yoga Mat', description: 'Premium TPE yoga mat with alignment lines. Eco-friendly, non-toxic, and lightweight for easy carrying.', rating: 4.5, totalReviews: 567, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: true, tags: ['yoga', 'fitness', 'mat'], specifications: { 'Material': 'TPE', 'Thickness': '6mm', 'Dimensions': '183x61cm', 'Weight': '1.2kg' } },
      { vendor: vendors[3]._id, category: sportsFitness._id, name: 'Adjustable Dumbbell Set', slug: 'adjustable-dumbbell-set', shortDescription: '20kg Adjustable Dumbbell Set with Stand', description: 'Space-saving adjustable dumbbells. Replace 6 pairs of dumbbells with one compact set.', rating: 4.2, totalReviews: 234, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: false, tags: ['dumbbell', 'weight', 'fitness'], specifications: { 'Weight': '2-20kg each', 'Increment': '2kg', 'Material': 'Cast Iron + Rubber', 'Stand': 'Included' } },
      { vendor: vendors[4]._id, category: books._id, name: 'Bestseller Book Bundle', slug: 'bestseller-book-bundle', shortDescription: 'Top 5 Bestseller Books Bundle', description: 'Curated collection of this year\'s top-rated fiction and non-fiction bestsellers.', rating: 4.8, totalReviews: 890, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: true, tags: ['books', 'bestseller', 'reading'], specifications: { 'Books': '5', 'Genre': 'Mixed Fiction & Non-Fiction', 'Format': 'Paperback', 'Language': 'English' } },
      { vendor: vendors[4]._id, category: beauty._id, name: 'Luxury Skincare Gift Set', slug: 'skincare-gift-set', shortDescription: 'Premium 5-Piece Skincare Gift Set', description: 'Complete skincare routine with cleanser, toner, serum, moisturizer, and face mask.', rating: 4.6, totalReviews: 445, approvalStatus: 'APPROVED', availabilityStatus: 'ACTIVE', isFeatured: true, isTrending: true, tags: ['skincare', 'beauty', 'gift'], specifications: { 'Pieces': '5', 'Skin Type': 'All Skin Types', 'Contains': 'Cleanser, Toner, Serum, Moisturizer, Mask', 'Cruelty Free': 'Yes' } },
    ]);
